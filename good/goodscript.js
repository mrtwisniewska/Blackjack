...
//Komunikaty
let loseInfo=['PRZEGRAŁEŚ :(', 'ZDARZA SIĘ NAJLEPSZYM', 'NASTĘPNYM RAZEM SIĘ UDA!', 'JEDNA PORAŻKA NIC NIE ZMIENIA, I TAK JESTEŚ SUPER'],
wonInfo=['WYGRAŁEŚ!','GRATULACJE, WYGRAŁEŚ!','MÓWIŁAM, ŻE WYGRASZ!'],
drawInfo=['REMIS','REMIS, ZDARZA SIĘ :)'];
...
function showStatus(){
  if (!gameStarted){
    textArea.innerHTML="<p class='inner'>Może zagramy?";
    return;
  }
